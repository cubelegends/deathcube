...
public class Language {
    private final File langYML = new File("plugins/DeathCube/language.yml");
    ...
    public Language(final DeathCubeManager plugin) {
        this.plugin = plugin;
    ...
    public void load() {
        ...
        } catch (final InvalidConfigurationException var5) {
        ...
        this.set("warningEnderPearl", ChatColor.GRAY + "Use your ender pearl in-game and you will be kicked.");
        ...
        this.set("leaveEnderPearlA", "Tried to use an ender pearl.");
        ...
        this.set("playingAlone", ChatColor.AQUA + "You are playing alone :(");
        ...
        this.set("towerDestroyed", ChatColor.AQUA + "Tower is completely destroyed!");
